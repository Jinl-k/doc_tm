<template>
	<view class="container">
		<img class="background-image" src="/src/im/static/background.svg" alt=""/>
		<view class="counter-warp">
			<view class="header-content">
				<img src="../../static/calling-logo.png" class="icon-box" alt="" />
...
// 这里需要使用commonJS来引入
const { TIM }  = require( '/src/wxcomponents/TUICallKit/TUICallEngine/libSrcConfig');
const template = '1v1';
const globalData =  {
